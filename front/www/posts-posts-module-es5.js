...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["posts-posts-module"], {
  ...
  /***/
  function node_modulesIonicNativeImagePicker__ivy_ngcc__NgxIndexJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "OutputType", function () {
      return OutputType;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "ImagePicker", function () {
      return ImagePicker;
    });
    /* harmony import */
    ...
    function (_super) {
      ...
      ImagePicker.prototype.getPictures = function (options) {
        return Object(_ionic_native_core__WEBPACK_IMPORTED_MODULE_2__["cordova"])(this, "getPictures", {
          "callbackOrder": "reverse"
        }, arguments);
      };

      ImagePicker.prototype.hasReadPermission = function () {
        return Object(_ionic_native_core__WEBPACK_IMPORTED_MODULE_2__["cordova"])(this, "hasReadPermission", {
          "platforms": ["Android"]
        }, arguments);
      };

      ImagePicker.prototype.requestReadPermission = function () {
        return Object(_ionic_native_core__WEBPACK_IMPORTED_MODULE_2__["cordova"])(this, "requestReadPermission", {
          "platforms": ["Android"]
        }, arguments);
      };
      ...
      ImagePicker.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({
        token: ImagePicker,
  ...
  function srcAppPostsPostsListGeneralPostsListGeneralPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var PostsListGeneralPage = /*#__PURE__*/function () {
      function PostsListGeneralPage(route, postService, storage) {
  ...
  function srcAppPostsPostsListPostsListPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var PostsListPage = /*#__PURE__*/function () {
      function PostsListPage(route, postService, storage) {
  ...
  function srcAppPostsPostsModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _posts_list_posts_list_module__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ./posts-list/posts-list.module */
    "./src/app/posts/posts-list/posts-list.module.ts");
    /* harmony import */


    var _posts_list_general_posts_list_general_module__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ./posts-list-general/posts-list-general.module */
    "./src/app/posts/posts-list-general/posts-list-general.module.ts");
  ...
  function srcAppPostsSellFormSellFormPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_shared_select_city_select_city_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    ...
    var SellFormPage = /*#__PURE__*/function () {
      function SellFormPage(router, postService, imagePicker, storage, modalController) {
      ...
      _createClass(SellFormPage, [{
        ...
        value: function saveSell() {
          ...
          this.postService.save(body, this.auth.token).toPromise().then(function (res) {
        ...
        value: function getImages() {
          ...
          this.imagePicker.getPictures(this.options).then(function (results) {
            for (var i = 0; i < results.length; i++) {
              _this9.imageResponse.push("data:image/jpeg;base64," + results[i]);
            }
          }, function (err) {
            alert(err);
          });
  ...
  function srcAppPostsShippingFormShippingFormPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ShippingFormPage = /*#__PURE__*/function () {
      function ShippingFormPage(postService, router, imagePicker, storage, modalController) {
      ...
      _createClass(ShippingFormPage, [{
              ...
              while (1) {
                switch (_context3.prev = _context3.next) {
                  ...
                  case 2:
                    ...
                    return modal.present().then(function () {
                      modal.onWillDismiss().then(function (response) {
                        _this11.origin = response.data.city;

                        if (_this11.origin) {
                          _this11.shippingForm.controls["origin"].setValue(_this11.origin.name);
                        } else {
                          _this11.shippingForm.controls["origin"].setValue(null);
                        }
                      });
                    });
              ...
              while (1) {
                switch (_context4.prev = _context4.next) {
                  ...
                  case 2:
                    ...
                    return modal.present().then(function () {
                      modal.onWillDismiss().then(function (response) {
                        _this12.destination = response.data.city;

                        if (_this12.destination) {
                          _this12.shippingForm.controls["destination"].setValue(_this12.destination.name);
                        } else {
                          _this12.shippingForm.controls["destination"].setValue(null);
                        }
                      });
                    });
        ...
        value: function getImages() {
          ...
          this.imagePicker.getPictures(this.options).then(function (results) {
            for (var i = 0; i < results.length; i++) {
              _this13.imageResponse.push("data:image/jpeg;base64," + results[i]);
            }
          }, function (err) {
            alert(err);
          });
