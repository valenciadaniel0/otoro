    ...
    var ShippingFormPage = /*#__PURE__*/function () {
      ...
      _createClass(ShippingFormPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.title = "Que quieres publicar?";
          this.sub = this.route.params.subscribe(function (params) {
            _this17.shippingId = params["id"];

            if (_this17.shippingId !== "0") {
              _this17.title = "Editar envio";
            }

            _this17.storage.get("auth").then(function (auth) {
              _this17.auth = auth;
              ...
              while (1) {
                switch (_context24.prev = _context24.next) {
                  ...
                  case 2:
                    ...
                    return modal.present().then(function () {
                      modal.onWillDismiss().then(function (response) {
                        _this18.origin = response.data.city;

                        if (_this18.origin) {
                          _this18.shippingForm.controls["origin"].setValue(_this18.origin.name);
                        } else {
                          _this18.shippingForm.controls["origin"].setValue(null);
                        }
                      });
                    });
              ...
              while (1) {
                switch (_context25.prev = _context25.next) {
                  ...
                  case 2:
                    ...
                    return modal.present().then(function () {
                      modal.onWillDismiss().then(function (response) {
                        _this19.destination = response.data.city;

                        if (_this19.destination) {
                          _this19.shippingForm.controls["destination"].setValue(_this19.destination.name);
                        } else {
                          _this19.shippingForm.controls["destination"].setValue(null);
                        }
                      });
                    });
        ...
        value: function getPost() {
          ...
          this.postService.getById(this.auth, this.shippingId).toPromise().then(function (res) {
            ...
            _this20.shippingForm.controls["title"].setValue(result.title);

            _this20.shippingForm.controls["description"].setValue(result.description);

            _this20.shippingForm.controls["date"].setValue(result.date);

            _this20.shippingForm.controls["origin"].setValue(result.origin.name);

            _this20.shippingForm.controls["destination"].setValue(result.destination.name);

            _this20.origin = result.origin;
            _this20.destination = result.destination;
          }, function (err) {
            var error = JSON.parse(err._body);
            console.log(error);
          });
            ...
            return regeneratorRuntime.wrap(function _callee28$(_context28) {
              while (1) {
                switch (_context28.prev = _context28.next) {
                  ...
                  case 14:
                    action.toPromise().then(function (res) {
                      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(_this21, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee26() {
                        var _this22 = this;
