    ...
    ngOnInit() {
        ...
        this.storage.get("auth").then((auth) => {
            ...
            if (this.auth.profilePicture) {
                this.storedPhoto = `${_environments_environment__WEBPACK_IMPORTED_MODULE_10__["environment"].profile_pictures_url}${this.auth.profilePicture}.jpg`;
            }
        });
    ...
    updateUser() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            this.usersService
                ...
                yield this.storage.set("auth", newAuth);
                yield this.getUser(newAuth.email);
